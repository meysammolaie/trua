...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "ما به شفافیت کامل اعتقاد داریم. همانطور که در مثال‌های عددی مشاهده کردید، کارمزدها به شرح زیر است: ۳٪ کارمزد ورود، ۲٪ کارمزد قرعه‌کشی و ۱٪ کارمزد پلتفرم. در زمان برداشت اصل سرمایه نیز ۲٪ کارمزد خروج اعمال می‌شود که به استخر سود برای سایر سرمایه‌گذاران بازمی‌گردد.",
  },
  {
